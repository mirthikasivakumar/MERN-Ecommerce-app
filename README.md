...
1. Clone the repository:
   ```bash
   git clone https://github.com/mirthikasivakumar/MERN-Ecommerce-app
...
- **Mirthika** - [mirthika](https://github.com/mirthikasivakumar)
- **Email:** [mirthikasiva05@gmail.com](mailto:mirthikasiva05@gmail.com).
